          ...
          <Table>
            <TableHead>
              <TableRow>
                ...
                <TableCell style={{fontSize:"14px",fontWeight:550}} align="right">Download</TableCell>
      ...
      <Dialog open={open} onClose={() => setOpen(false)}>
        ...
        <DialogContent>
          ...
          <label htmlFor="new-doc-file">
            <Button variant="contained" color="primary" component="span" style={{ marginTop: '10px',fontSize:"9px" }}>
              Upload File
            </Button>
          </label>
          {newDocFile && (
